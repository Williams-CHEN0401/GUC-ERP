...
const MODAL_PERMISSIONS={customerModal:'customers',customerCategoryModal:'customers',supplierModal:'suppliers',accountModal:'users',categoryModal:'inventory',itemModal:'inventory',projectModal:'projects',pickupModal:'pickups',receiptModal:'purchases',repairModal:'repairs',workLogModal:'worklogs',workLogPickupModal:'pickups',attachmentModal:'equipment'};

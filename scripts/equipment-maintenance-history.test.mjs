...
test("ERP form supports multiple events, multi-device drawer and preview-only simulation", () => {
  for (const marker of ['name="hasMaintenance"', "data-add-maintenance-event", "data-open-equipment-picker", "equipment-drawer", "collectMaintenanceEvents", "maintenance_event_count"]) assert.ok(`${app}\n${styles}`.includes(marker), marker);

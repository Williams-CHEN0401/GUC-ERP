...
test('new work-log initial and refreshed choices exclude completed while preserving customer and grants',()=>{
 ...
 const ctx=vm.createContext({state,esc:v=>v||'',workLogFormCustomerId:()=>form.elements.customerId?.value||'',projectMatchesDepartment:()=>true,workLogTitleDepartment:()=>undefined,modalDepartmentFilter:()=>undefined,document:{querySelector:()=>form}});

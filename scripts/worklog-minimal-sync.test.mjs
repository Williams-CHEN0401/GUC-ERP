...
test('非設備事件不送出未登錄的品項；已登錄關聯與設備履歷維持原值',()=>{
  ...
  vm.runInContext(helper+between('function workLogContentFields','function workLogSummaryForSave')+between('function collectMaintenanceEvents','function projectOwnerPickerField'),ctx);
